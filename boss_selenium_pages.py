...
for i in range(85):
    ...
    pages = int(browser.find_element(by=By.XPATH, value='//*[@id="main"]/div/div[2]/div/span[2]').text.split('/')[1])

    # Loop through each page
    for page in range(1, pages + 1):
        # Navigate to the current page
        browser.get('https://www.zhipin.com/guangzhou/?ka=city-sites-101280100&pg={}'.format(page))

        # Wait for the page to load
        time.sleep(5)

        # Get all job listings on the page
        job_detail = browser.find_elements(by=By.XPATH, value='//*[@id="main"]/div/div[2]/div/div[2]/ul/li')
