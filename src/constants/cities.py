...
def get_cities_by_province(province: str) -> list:
    """根据省份获取城市列表"""
...
def get_all_cities() -> list:
    """获取所有城市列表"""
    cities = []
    for city_list in CITY_MAP.values():
        cities.extend(city_list)
    return cities

# 使用示例
if __name__ == '__main__':
    print("省份数量:", len(get_all_provinces()))
    print("城市数量:", len(get_all_cities()))
    print("北京的城市:", get_cities_by_province("北京"))
    print("深圳的省份:", get_province_by_city("深圳"))
